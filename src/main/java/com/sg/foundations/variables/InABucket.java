...
public class InABucket {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("My teacup pig weighs " + weightOfTeacupPig);
        System.out.println("Anakin Skywalker hates " + grainsOfSand + " percent of all grains of sand.");
